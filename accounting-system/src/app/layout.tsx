...
//this layout wraps the whole app. set up providers and route auth protections, wrap pages in navbar and footer and also add a max page width to whole site
